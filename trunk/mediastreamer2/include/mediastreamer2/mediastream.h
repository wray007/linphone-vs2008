...
typedef void (*MediaQualityCb_t)(void *userdata, int jitter, float packet_lost);
...
void audio_stream_set_quality_callback(AudioStream *stream, void *userdata, MediaQualityCb_t cb);
...
/*Noise Reduction*/
void audio_stream_enable_noise_reduction(AudioStream *stream, bool_t val);

/*Enable Record*/
void audio_stream_enable_recored_file(AudioStream *stream, bool_t val);

/*Enable Record*/
bool_t audio_stream_recored_file_enabled(AudioStream *stream);
